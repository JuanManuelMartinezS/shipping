...
public class Controller<T> {
  ...
  public Controller(final Service<T> service) {
    ...
    path(
        ...
        () -> {
          ...
          get(
              "/index/{param}", // buscar por el índice o posición en el array
              ctx -> {
          ...
          /**
           * Agregue al constructor de la clase Controller un nuevo llamado de tipo GET
           * que permita obtener el conteo de registros de clientes, mercancías y envíos
           * mediante endpoints de la forma:
          ...
          patch(
              ...
              ctx -> {
                String id = ctx.pathParam("param");
                response(ctx, service.removeStatus(id));
              });
  ...
  public void info() {
    System.out
        .println(String.format("%s>> Creados los endpoints para %sService%s", Utils.BLUE, currentPath, Utils.RESET));
  }
}
// Ctx es un objeto que contiene el contexto de las peticiones y las respuestas
// del http, este esta dentro de Javalin
